...
* [IV. Spring Boot的功能](IV.Spring_Boot_features/README.md)
    ...
    * [24. 外部化配置](IV.Spring_Boot_features/24.Externalized_Configuration.md)
        ...
        * [24.4 特定profile的属性](IV.Spring_Boot_features/24.4.Profile-specific_properties.md)
        ...
        * [24.6 使用YAML代替properties](IV.Spring_Boot_features/24.6.Using_YAML_instead_of_Properties.md)
            ...
            * [24.6.3 多个profile的YAML文档](IV.Spring_Boot_features/24.6.3.Multi-profile_YAML_documents.md)
        ...
        * [24.7 类型安全的配置属性](IV.Spring_Boot_features/24.7.Type-safe_Configuration_Properties.md)
            ...
            * [24.7.5 @ConfigurationProperties vs. @Value](IV.Spring_Boot_features/24.7.5.@ConfigurationProperties_vs._@Value.md)
    * 25. Profiles
    * [26. 日志](IV.Spring_Boot_features/26.Logging.md)
        ...
        * [26.6 Logback扩展](IV.Spring_Boot_features/26.6.Logback_extensions.md)
            * [26.6.1 特定profile配置](IV.Spring_Boot_features/26.6.Logback_extensions.md#261-特定profile配置)
            * [26.6.2 Environment属性](IV.Spring_Boot_features/26.6.Logback_extensions.md#262-Environment属性)
    ...
    * [41. 测试](IV.Spring_Boot_features/41.Testing.md)
        ...
        * [41.3 测试Spring Boot程序](IV.Spring_Boot_features/41.3.Testing_Spring_Boot_applications.md)
            ...
            * [41.3.5 模拟bean和间谍bean](IV.Spring_Boot_features/41.3.5.Mocking_and_spying_beans.md)
            ...
            * [41.3.12 自动配置的Rest客户端](IV.Spring_Boot_features/41.3.12.Auto-configured_REST_clients.md)
